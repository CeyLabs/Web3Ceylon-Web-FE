...
import { range } from "@/lib/gallery/range";
...
export default function SharedModal({
    ...
    const filteredImages =
        images?.filter((img: ImageProps) => range(index - 15, index + 15).includes(img.id)) ?? [];
                        ...
                        <div className="relative aspect-[3/2] max-h-full w-full">
                            ...
                            <div className="absolute right-0 top-0 flex items-center gap-2 p-3 text-white">
                                {navigation ? (
                                    ...
                                    <a
                                        href={`https://twitter.com/intent/tweet?text=Check%20out%20this%20Web3Ceylon%202025%20photo!%0A%0Ahttps://web3ceylon.com/2025/album?photoId=${index}`}
                                        className="rounded-full bg-black/50 p-2 text-white/75 backdrop-blur-lg transition hover:bg-black/75 hover:text-white"
                                        target="_blank"
